    ...
    <div className="p-8 max-w-4xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">{activeCount} active projects</p>
        </div>
      ...
      {showForm && (
        <Card className="mb-6 border-nebula-200 shadow-elevated animate-in fade-in slide-in-from-top-1 duration-200">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button size="sm" onClick={handleCreate} loading={submitting}>Create Project</Button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {loading ? (
          ...
          <Card className="col-span-2">
            <EmptyState icon={FolderOpen} title="No projects yet" description="Create the first project to start tracking time against it." />
          </Card>
        ) : projects.map((p: any) => (
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-nebula-50 rounded-lg mt-0.5">
                    <FolderOpen size={16} className="text-nebula-600" />
                  </div>
                  <div>
                    ...
                    <Badge variant={p.is_active ? 'success' : 'outline'} dot className="mt-2">
