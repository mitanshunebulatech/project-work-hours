      ...
      <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-2 duration-500">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white shadow-elevated p-8">
          <div className="mb-6 flex items-start gap-3">
            ...
            <div>
              <h1 className="text-lg font-display font-semibold text-slate-900 mb-1">Password change required</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-slate-400">At least 8 characters, with a letter and a digit.</p>
            </div>
          ...
          <button
            ...
            className="w-full mt-4 flex items-center justify-center gap-1.5 text-xs font-medium text-slate-400 hover:text-slate-600 transition-colors"
          >
